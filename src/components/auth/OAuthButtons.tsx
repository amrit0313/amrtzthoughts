...
export function OAuthButtons() {
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      <Button variant="outline" type="button" onClick={handleGoogle} className="w-full flex items-center gap-2">
      ...
      <Button variant="outline" type="button" onClick={handleFacebook} className="w-full flex items-center gap-2">
